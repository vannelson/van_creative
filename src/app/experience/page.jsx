...
const experiences = [
  {
    company: "Envireau Pacific Incorporated",
    ...
    highlights: [
      "Create 'Accounting Collection System' using Vue and Laravel. Crucial for tracking client accounts, managing payments, and monitoring payable aging in the accounting departmen",
      ...
      >
        <Box
          sx={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(600px 200px at 30% -20%, rgba(34,197,94,0.12), transparent 60%)",
          }}
        />
